         ...
         <div class="how-work-cection__container _container">
            <Card class="how-work-cection__content">
               ...
               <div class="how-work-cection__text">
                  We make it easy for you to buy your dream car from your phone without ever having to step into a
                  dealership! We deliver your vehicle to your home for you to test drive before you sign anything.
               </div>
            </Card>
         </div>
      </div>
         ...
         <div class="working-advantages-section__content-box">
            <div class="working-advantages-section__triangle-box">
               ...
               <div class="working-advantages-section__triangle-content">
                  ...
                  <div class="working-advantages-section__text">
                     We deliver your vehicle directly to your door. You don’t sign anything until you test drive the
                     vehicle. There is never any obligation to buy beforehand.
                  </div>
               </div>
            </div>
            <div class="working-advantages-section__triangle-box">
               <img v-if="triangleRotation" class="working-advantages-section__triangle"
                  src="../img/HomePage/Vector-first.svg" alt="">
            ...
            <div class="working-advantages-section__triangle-box">
               ...
               <div class="working-advantages-section__triangle-content ">
                  ...
                  <div class="working-advantages-section__text">
                     We have access to thousands of high-quality vehicles and offer them to you at wholesale prices. Your
                     dream car is waiting for you
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="inventory-button-section__text-box">
            ...
            <div class="inventory-button-section__content-box">
               ...
               <router-link to="/catalog">
                  <Button class="inventory-button-section__button" text="Inventory" :width=190 mobileWidth="100%"
                     :mobileHight="35" />
               </router-link>
            </div>
         </div>
      ...
      <div class="statistic-section__container _container">
         ...
         <div class="statistic-section__question-box">
            ...
            <router-link to="/quiz/0">
               <Button class="statistic-section__button" :width="200" :mobile-hight="35" />
            </router-link>
         </div>
      </div>
   </div>
