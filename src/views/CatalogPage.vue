      ...
      <div class="car-catalog__container _container">
         <div class="car-catalog__filters-box" :class="[menuStore.isActiveFilter, menuStore.filterUnderMenu]">
            <div class="car-catalog__title-box">
               ...
               <div
                  v-if="makeFilters.length > 0 || bodyTypeFilter.length > 0 || transmissionFilter.length > 0 || priceFilters.length > 0 || yearFilters.length > 0 || kilometresFilters.length > 0"
                  class="car-catalog__clear" @click="resetAllFilters">
                  Clear filters
               </div>
            </div>
            <div class="car-catalog__filters">
               <div class="car-catalog__make-model">
                  <Accordeon @openAccordeon="openMakeModel = !openMakeModel">
                     ...
                     <template v-slot:tag>
                        <div class="car-catalog__used-filters" v-if="!openMakeModel && makeFilters.length > 0">
                           <Tag v-for="filter in makeFilters"
                              @click="closeMakeTage(makeFilters, filter, selectAllMakeModel.arrayMake)">
                              {{ filter }}
                           </Tag>
                           <Tag v-for="filter in modelFilters" @click="closeTag(modelFilters, filter, selectedModel)">
                              {{ filter }}
                           </Tag>
                        </div>
                     </template>
                     <template v-slot:content>
                        ...
                        <div class="car-catalog__selectid-in-input" v-if="openMakeModel">
                        ...
                        <div class="car-catalog__input-box">
                           <img src="../img/icons/Search.svg" alt="Search" class="car-catalog__input-icon">
                           <input class="car-catalog__input-text input__model" type="text" name="model" id="model"
                              v-model="modelValue" placeholder="Search Model..." autocomplete="off"
                              :disabled="makeFilters.length < 1" @focus="activeModel = true" @blur="activeModel = false">
                           <div v-if="activeModel" class="car-catalog__input-select">
                              <div class="car-catalog__select-item" v-if="selectedModel.length > 0"
                                 v-for="model in filterSelectedModel" @mousedown="addModelFilter(model)">
                                 {{ model }}
                              </div>
               ...
               <div class="car-catalog__body-type">
                  <Accordeon @openAccordeon="openBodyType = !openBodyType">
                     ...
                     <template v-slot:tag>
                        <div class="car-catalog__used-filters" v-if="!openBodyType && bodyTypeFilter.length > 0">
                           <Tag v-for="filter in bodyTypeFilter" @click="checkbox[filter] = false">
                              {{ filter }}
                           </Tag>
                        </div>
                     </template>
                        ...
                        <fieldset>
                           <div class="car-catalog__checkbox" v-if="!disabledTrucks">
                              <label class="car-catalog__label-checkbox" for="trucks">
                                 <input class="car-catalog__checkbox-input" type="checkbox" id="trucks" name="body-type"
                                    value="trucks" v-model='checkbox.Trucks' :disabled="disabledTrucks" />
                                 <span class="car-catalog__checkbox-span"
                                    :class="{ 'active-checbox': checkbox.Trucks }"></span>
                                 <img src="../img/icons/TruckIcon.svg" alt="Truck icon"
                                    class="car-catalog__input-car-icon">
                           ...
                           <div class="car-catalog__checkbox" v-if="!disabledSedan">
                              <label class="car-catalog__label-checkbox" for="sedan">
                                 <input class="car-catalog__checkbox-input" type="checkbox" id="sedan" name="body-type"
                                    value="sedan" v-model='checkbox.Sedan' :disabled="disabledSedan" />
                                 <span class="car-catalog__checkbox-span"
                                    :class="{ 'active-checbox': checkbox.Sedan }"></span>
                                 <img src="../img/icons/SedanIcon.svg" alt="Sedan icon"
                                    class="car-catalog__input-car-icon">
                                 <div class="car-catalog__label-text">
                                    Sedan
                                 </div>
                           ...
                           <div class="car-catalog__checkbox" v-if="!disabledHatchback">
                              <label class="car-catalog__label-checkbox" for="hatchback">
                                 <input class="car-catalog__checkbox-input" type="checkbox" id="hatchback" name="body-type"
                                    value="hatchback" v-model='checkbox.Hatchback' :disabled="disabledHatchback" />
                                 <span class="car-catalog__checkbox-span"
                                    :class="{ 'active-checbox': checkbox.Hatchback }"></span>
                                 <img src="../img/icons/HatchbackIcon.svg" alt="Hatchback icon"
                                    class="car-catalog__input-car-icon">
                                 <div class="car-catalog__label-text">
                                    Hatchback
                                 </div>
                           ...
                           <div class="car-catalog__checkbox" v-if="!disabledCoupe">
                              <label class="car-catalog__label-checkbox" for="coupe">
                                 <input class="car-catalog__checkbox-input" type="checkbox" id="coupe" name="body-type"
                                    value="coupe" v-model='checkbox.Coupe' :disabled="disabledCoupe" />
                                 <span class="car-catalog__checkbox-span"
                                    :class="{ 'active-checbox': checkbox.Coupe }"></span>
                                 <img src="../img/icons/CoupeIcon.svg" alt="Coupe icon"
                                    class="car-catalog__input-car-icon">
                                 <div class="car-catalog__label-text">
                                    Coupe
                                 </div>
                           ...
                           <div class="car-catalog__checkbox" v-if="!disabledConvertiable">
                              <label class="car-catalog__label-checkbox" for="convertiable">
                                 <input class="car-catalog__checkbox-input" type="checkbox" id="convertiable"
                                    name="body-type" value="convertiable" v-model='checkbox.Convertiable'
                                    :disabled="disabledConvertiable" />
                                 <span class="car-catalog__checkbox-span"
                                    :class="{ 'active-checbox': checkbox.Convertiable }"></span>
                                 <img src="../img/icons/ConvertiableIcon.svg" alt="Convertiable icon"
                                    class="car-catalog__input-car-icon">
                                 <div class="car-catalog__label-text">
                                    Convertiable
                                 </div>
                  ...
                  <Accordeon @openAccordeon="openTransmission = !openTransmission">
                     ...
                     <template v-slot:tag>
                        <div class="car-catalog__used-filters" v-if="!openTransmission && transmissionFilter.length > 0">
                           <Tag v-for="filter in transmissionFilter" @click="checkboxTrans[filter] = false">
                              {{ filter }}
                           </Tag>
                        </div>
                     </template>
                        ...
                        <fieldset>
                           <div class="car-catalog__checkbox" v-if="!disabledAutomatic">
                              <label class="car-catalog__label-checkbox" for="automatic">
                                 <input class="car-catalog__checkbox-input" type="checkbox" id="automatic"
                                    name="transmission" value="automatic" v-model='checkboxTrans.Automatic' />
                                 <span class="car-catalog__checkbox-span"
                                    :class="{ 'active-checbox': checkboxTrans.Automatic }"></span>
                                 <div class="car-catalog__label-text">
                                    Automatic
                                 </div>
                              </label>
                           ...
                           <div class="car-catalog__checkbox" v-if="!disabledManual">
                              <label class="car-catalog__label-checkbox" for="manual">
                                 <input class="car-catalog__checkbox-input" type="checkbox" id="manual" name="transmission"
                                    value="manual" v-model='checkboxTrans.Manual' />
                                 <span class="car-catalog__checkbox-span"
                                    :class="{ 'active-checbox': checkboxTrans.Manual }"></span>
                                 <div class="car-catalog__label-text">
                                    Manual
                                 </div>
                              </label>
               ...
               <div class="car-catalog__price">
                  <Accordeon @openAccordeon="openPrice = !openPrice">
                     ...
                     <template v-slot:content>
                        ...
                        <Slider v-model="price.value" :min="priceMinMax[0]" :max="priceMinMax[1]" :step="100"
                           :tooltips="false" :lazy="false" @change="selectPriceFilter" />
                        <div class="car-catalog__selectid-in-input">
                           <Tag v-if="openPrice && priceFilters.length > 0" @closeTag="cleaningPriceFilters()">
                              $ {{ selectedValue(priceFilters, 0) }} - $ {{ selectedValue(priceFilters, 1) }}
                           </Tag>
                        </div>
                     </template>
               ...
               <div class="car-catalog__year">
                  <Accordeon @openAccordeon="openYear = !openYear">
                     ...
                     <template v-slot:content>
                        ...
                        <Slider v-model="year.value" :min="yearMimMax[0]" :max="yearMimMax[1]" :tooltips="false"
                           :lazy="false" @change="selectYearFilter" />
                        <!--@update="closeYearTag"-->
                        <div class="car-catalog__selectid-in-input">
               ...
               <div class="car-catalog__kilometres">
                  <Accordeon @openAccordeon="openKilometres = !openKilometres">
                     ...
                     <template v-slot:content>
                        ...
                        <Slider v-model="kilometres.value" :min="kilometresMimMax[0]" :max="kilometresMimMax[1]"
                           :step="100" :tooltips="false" :lazy="false" @change="selectKilometresFilter" />
                        <div class="car-catalog__selectid-in-input">
                           <Tag v-if="openKilometres && kilometresFilters.length > 0"
                              @closeTag="cleaningKilometresFilters">
                              {{ selectedValue(kilometresFilters, 0) }}
                           </Tag>
                        </div>
                     </template>
               ...
               <Button class="car-catalog__button" id="filters-button" text="Apply" :width=137 tabletWidth="100%"
                  @click="doFiltering" />
            </div>
         </div>
         <div class="car-catalog__catalog">
            <div class="car-catalog__search-sorting">
               <div class="car-catalog__search-box">
                  ...
                  <div class="car-catalog__input-box">
                     <img src="../img/icons/Search.svg" alt="Search" class="car-catalog__input-icon">
                     <input class="car-catalog__input-text input__search" type="text" name="search" id="search"
                        v-model="searchValue" placeholder="Find a dream car..." autocomplete="off"
                        @focus="activeSearch = true" @blur="activeSearch = false">
                     <div v-if="selectListForSearch.length > 0 && activeSearch" class="car-catalog__input-select">
                        <div class="car-catalog__select-item" v-for="item in selectListForSearch"
                     ...
                     <div class="car-catalog__active-field" @click="activeSortList = !activeSortList">
                        ...
                        <div class="car-catalog__active-field-icon">
                           <img src="../img/icons/Arrow-Bottom.svg" alt="" class="car-catalog__arrow-bottom"
                              :class="{ 'rotate-icon': activeSortList }">
                        </div>
                     </div>
                     <ul class="car-catalog__sort-selection-list" v-if="activeSortList">
                        <li v-for="item in currentSortList" class="car-catalog__sort-item" @click="selestSortItem(item)">
                           {{ item }}
                        </li>
                     </ul>
                  </div>
            ...
            <div v-if="pagination.length > 1" class="car-catalog__pagination-box">
               <div v-for="n in pagination" class="car-catalog__pagination"
